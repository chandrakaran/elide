...
public class DefaultResultStorageEngineTest {
    ...
    public void testGetResultsByID() {
        ...
        assertEquals(id,
                defaultResultStorageEngine.getResultsByID(n.getId()).getId());
    }
    ...
    public void testDeleteResultsByID() {
        ...
        defaultResultStorageEngine.deleteResultsByID(n.getId());

        verify(tx, times(1)).loadObject(any(), any(), any());
        verify(tx, times(1)).delete(any(), any());
        assertEquals(id,
                defaultResultStorageEngine.deleteResultsByID(n.getId()).getId());
    }
